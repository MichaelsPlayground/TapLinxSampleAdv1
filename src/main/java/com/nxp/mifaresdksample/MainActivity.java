...
import static com.nxp.mifaresdksample.Constants.ALIAS_DEFAULT_FF;
import static com.nxp.mifaresdksample.Constants.ALIAS_KEY_2KTDES;
import static com.nxp.mifaresdksample.Constants.ALIAS_KEY_2KTDES_ULC;
import static com.nxp.mifaresdksample.Constants.ALIAS_KEY_AES128;
import static com.nxp.mifaresdksample.Constants.ALIAS_KEY_AES128_ZEROES;
import static com.nxp.mifaresdksample.Constants.EMPTY_SPACE;
import static com.nxp.mifaresdksample.Constants.EXTRA_KEYS_STORED_FLAG;
import static com.nxp.mifaresdksample.Constants.KEY_AES128_DEFAULT;
import static com.nxp.mifaresdksample.Constants.KEY_APP_MASTER;
import static com.nxp.mifaresdksample.Constants.PRINT;
import static com.nxp.mifaresdksample.Constants.STORAGE_PERMISSION_WRITE;
import static com.nxp.mifaresdksample.Constants.TAG;
import static com.nxp.mifaresdksample.Constants.TOAST;
import static com.nxp.mifaresdksample.Constants.TOAST_PRINT;
import static com.nxp.mifaresdksample.Constants.bytesKey;
import static com.nxp.mifaresdksample.Constants.cipher;
import static com.nxp.mifaresdksample.Constants.default_ff_key;
import static com.nxp.mifaresdksample.Constants.default_zeroes_key;
import static com.nxp.mifaresdksample.Constants.iv;
import static com.nxp.mifaresdksample.Constants.objKEY_2KTDES;
import static com.nxp.mifaresdksample.Constants.objKEY_2KTDES_ULC;
import static com.nxp.mifaresdksample.Constants.objKEY_AES128;
import static com.nxp.mifaresdksample.Constants.packageKey;
            ...
            case DESFireEV3:
                ...
                if (idesFireEV3.getSubType() == IDESFireEV3.SubType.MIFAREIdentity) {
                    ...
                    try {
                        ...
                        showImageSnap(R.drawable.desfireev3);
                        showMessage(mCardLogic.desfireEV3CardLogic(this, idesFireEV3), PRINT);
                    } catch (Throwable t) {
                        t.printStackTrace();
                        showMessage(getString(R.string.unknown_Error_Tap_Again), TOAST_PRINT);
                    }
            ...
            case DESFireEV3C:
                ...
                if (idesFireEV3C.getSubType() == IDESFireEV3C.SubType.MIFAREIdentity) {
                    ...
                    try {
                        ...
                        showImageSnap(R.drawable.desfireev3c);
                        showMessage(mCardLogic.desfireEV3CardLogic(this, idesFireEV3C), PRINT);
                    } catch (Throwable t) {
                        t.printStackTrace();
                        showMessage(getString(R.string.unknown_Error_Tap_Again), TOAST_PRINT);
                    }
